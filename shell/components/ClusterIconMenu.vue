...
<style lang="scss" scoped>
  ...
  // The cog inside the Kubernetes shield stays white so the detail remains
  // visible regardless of the theme color applied to the shield.
  .cluster-local-logo-cog {
    fill: #ffffff;
  }
